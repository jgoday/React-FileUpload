    ...
    render: function render() {
        ...
        if (this.isIE) {
            ...
            render = React.createElement(
                ...
                this.state.after,
                React.createElement('input', _extends({ type: 'file', name: 'ajax_upload_file_input', ref: function ref(_ref) {
                        return _this4.ajaxUploadFileInput = _ref;
                    },
